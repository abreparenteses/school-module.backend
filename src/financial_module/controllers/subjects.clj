(ns financial-module.controllers.subjects
  (:require [financial-module.db.subjects :as db.subjects]
            [financial-module.logics.subjects :as logics.subjects]
            [financial-module.schemas.db.subjects :as schemas.db.subjects]
